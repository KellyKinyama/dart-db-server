...
class Table {
  ...
  final Map<String, String> indexNamesToColumns =
      {}; // To map index name to column

  // final Map<String, BTreeNode> _btreeIndexes = {};
  Table(this.columns);

  void createIndex(String columnName, {String? indexName}) {
    ...
    final actualIndexName = indexName ?? columnName; // Default index name
    indexes[columnName] = map;
    indexNamesToColumns[actualIndexName] = columnName;
    print("Index '$actualIndexName' created on column '$columnName'.");
  }
